...
<html>
    <head>
        ...
        <title>searchTitle.jsp</title> <!-- Title of the webpage -->
    </head>
    <body>
        <div id="title"><h1>Search Results for "<%=request.getParameter("songName")%>"</h1></div> <!-- Prompts the user of the search results for their username -->
        <%
        ...
        try // Run this code before the other block
        {
            ...
            ArrayList<Song> songs = dao.findSongByName(request.getParameter("songName"));  // Fills the array list with songs that have the user entered artist
            %>
